...
find_library(LZ4_LIBRARY_PATH NAMES liblz4.so)

if (LZ4_INCLUDE_DIR AND LZ4_LIBRARY_PATH)
  set(LZ4_FOUND TRUE)
  set(LZ4_LIBRARY ${LZ4_LIBRARY_PATH})
else ()
  set(LZ4_FOUND FALSE)
endif ()
...
if (LZ4_FOUND)
  if (NOT Lz4_FIND_QUIETLY)
    ...
    message(STATUS "Found Lz4 library: ${LZ4_LIBRARY_PATH}")
  endif ()
else ()
  if (NOT Lz4_FIND_QUIETLY)
    set(LZ4_ERR_MSG "Could not find the Lz4 library. Looked for headers")
    set(LZ4_ERR_MSG "${LZ4_ERR_MSG} in ${LZ4_INCLUDE_DIR}, and for libs")
    set(LZ4_ERR_MSG "${LZ4_ERR_MSG} in ${LZ4_LIBRARY_PATH}")
